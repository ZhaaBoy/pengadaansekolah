    ...
    <div class="py-6 px-6 lg:px-10" x-data="{ open: false, selectedId: null }"
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="py-3 px-4 text-center">
                                    @if ($bayar->invoice_path)
                                        <a href="{{ asset('storage/' . $bayar->invoice_path) }}" target="_blank"
                                            class="text-indigo-600 hover:underline text-sm">Lihat Invoice</a>
                                    @else
                                ...
                                <td class="py-3 px-4 text-center">
                                    @if (!$bayar->bukti && $p->status == 'menunggu_pembayaran')
                                        <button @click="$dispatch('open-modal', { id: {{ $bayar->id }} })"
        ...
        <div x-show="open" x-cloak
            ...
            <div class="bg-white/90 border border-purple-200 rounded-2xl shadow-2xl max-w-md w-full p-6 relative animate-fadeIn"
                ...
                <h2 class="text-xl font-bold text-purple-700 mb-4 text-center">Upload Bukti Transfer</h2>
