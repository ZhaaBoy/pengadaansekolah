<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role === 'vendor')
                        ...
                        {{-- ✅ Tambahan baru --}}
                        <x-nav-link href="{{ route('vendor.pembayaran.index') }}" :active="request()->routeIs('vendor.pembayaran.*')">
                            Kelola Pembayaran
                        </x-nav-link>
                    @endif
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- === RESPONSIVE: STAFF === --}}
            @if (Auth::user()->role === 'staff')
                <x-responsive-nav-link href="{{ route('pengadaan.index') }}" :active="request()->routeIs('pengadaan.*')">
                    Pengadaan
                </x-responsive-nav-link>
            ...
            @if (Auth::user()->role === 'vendor')
                ...
                {{-- ✅ Tambahan baru --}}
                <x-responsive-nav-link href="{{ route('vendor.pembayaran.index') }}" :active="request()->routeIs('vendor.pembayaran.*')">
                    Kelola Pembayaran
                </x-responsive-nav-link>
            @endif

            {{-- === RESPONSIVE: KEPALA SEKOLAH === --}}
            @if (Auth::user()->role === 'kepala_sekolah')
